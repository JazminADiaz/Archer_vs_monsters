...
pygame.display.set_caption('Archer_vs_monsters')
...
height=20
y_vel=height
arrow_image = pygame.image.load(f'Archer_vs_monsters/img/arrow.png').convert_alpha()
arrow_image= pygame.transform.scale(arrow_image, (int(arrow_image.get_width() * 0.1), int(arrow_image.get_height() * 0.1)))
instructions_image=pygame.image.load(f'Archer_vs_monsters/img/instructions.png').convert_alpha()
...
def game(mosters_num):
    ...
    floor(f'Archer_vs_monsters/img/grass.png')
    # heroine
...
class mosters(pygame.sprite.Sprite):
    def __init__(self,x,y,num_monster):
        ...
        monster =pygame.image.load(f'Archer_vs_monsters/img/moster{num_monster}.png').convert_alpha()
...
class characters(pygame.sprite.Sprite):
    def __init__(self,x,y):
        pygame.sprite.Sprite.__init__(self)
        frame = pygame.image.load(f'Archer_vs_monsters/img/0.png').convert_alpha()
        self.doll_height=y
        self.image=frame
        self.rect=self.image.get_rect()
        self.rect.center=(x,y)
...
start =pygame.image.load(f'Archer_vs_monsters/img/START.png').convert_alpha()
exit =pygame.image.load(f'Archer_vs_monsters/img/EXIT.png').convert_alpha()
start_button=Button(scren_x/2, 100, start)
exit_button=Button(scren_x/2, 300, exit)

#second menu buttons check
level1=pygame.image.load(f'Archer_vs_monsters/img/LEVEL1.png').convert_alpha()
level2=pygame.image.load(f'Archer_vs_monsters/img/LEVEL2.png').convert_alpha()
level3=pygame.image.load(f'Archer_vs_monsters/img/LEVEL3.png').convert_alpha()
